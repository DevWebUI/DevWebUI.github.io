...
// not a fallback, it is a second claim. Nothing kept this file honest before: the page declared no downloadUrl at all and claimed softwareVersion 0.8.7.
//
...
const DL_ASSETS = {
  'win-x64': 'devwebui-windows-x64.exe',
  'win-x64-zip': 'devwebui-windows-x64.zip',
  'win-x64-tray': 'devwebui-windows-x64-with-tray.zip',
  'macos-arm64': 'devwebui-macos-arm64.tar.gz',
  'linux-x64': 'devwebui-linux-x64.tar.gz',
...
async function latestRelease() {
  const headers = { Accept: 'application/vnd.github+json', 'User-Agent': 'devwebui-site-sync' };
